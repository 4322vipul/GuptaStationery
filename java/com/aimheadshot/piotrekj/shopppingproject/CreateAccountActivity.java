...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference=firebaseDatabase.getReference().child("NewUsers");
        firebaseAuth=FirebaseAuth.getInstance();
        storageReference= FirebaseStorage.getInstance().getReference().child("new_profile_pics");
    ...
    private void createNewAccount() {
        ...
        if(len>=6) {
            ...
            Toast.makeText(CreateAccountActivity.this,"Password needs to be atleast 6 digits long!",Toast.LENGTH_LONG).show();
        }
    }
    @Override
